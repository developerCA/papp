...
var data = [{
    ...
    },
	{
        ...
        movieId: 2,
        price: 2,
        startDate: new Date(2015, 4, 24, 21, 30),
        endDate: new Date(2015, 4, 24, 22, 53)
    }, {
        theatreId: 0,
        movieId: 5,
        price: 2,
        startDate: new Date(2015, 4, 25, 9, 20),
        ...
        movieId: 4,
        price: 1,
        startDate: new Date(2015, 4, 25, 16, 30),
        ...
        movieId: 5,
        price: 3,
        startDate: new Date(2015, 4, 26, 15, 30),
        ...
        endDate: new Date(2015, 4, 27, 10, 30)
    }, {
        theatreId: 0,
        movieId: 2,
        price: 1,
        startDate: new Date(2015, 4, 27, 11, 0),
        endDate: new Date(2015, 4, 27, 12, 30)
    }, {
        theatreId: 0,
        movieId: 3,
        price: 2,
        startDate: new Date(2015, 4, 27, 13, 30),
        endDate: new Date(2015, 4, 27, 15, 0)
    }, {
        theatreId: 0,
        movieId: 5,
        price: 2,
        startDate: new Date(2015, 4, 27, 15, 30),
        endDate: new Date(2015, 4, 27, 17, 30)
    }, {
        theatreId: 0,
        movieId: 4,
        price: 1,
