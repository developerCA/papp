...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'MenuToCtrl':'assets/js/controllers/menuToCtrl.js',
        'UsuarioFactory':'assets/js/factory/usuariosFactory.js',
        'SucursalFactory':'assets/js/factory/sucursalesFactory.js',
        'ClienteFactory':'assets/js/factory/clientesFactory.js',
        'ServicioFactory':'assets/js/factory/serviciosFactory.js',
        'ColaboradorFactory':'assets/js/factory/colaboradoresFactory.js',
        'CitaFactory':'assets/js/factory/citasFactory.js',
        'ColaboradorCtrl':'assets/js/controllers/colaboradorCtrl.js',
        'ServiciosCtrl':'assets/js/controllers/serviciosCtrl.js',
        'EmpresaFactory':'assets/js/factory/empresaFactory.js',
        'EmpresaCtrl':'assets/js/controllers/empresaCtrl.js',
        'SucursalCtrl':'assets/js/controllers/sucursalCtrl.js',
        'UsuarioCtrl':'assets/js/controllers/usuarioCtrl.js',
        'PrincipalCtrl':'assets/js/controllers/principalCtrl.js',
