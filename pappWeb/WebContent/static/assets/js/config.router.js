...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        resolve: loadSequence('ui.select','moment', 'mwl.calendar', 'calendarCtrl','SucursalFactory','ClienteFactory','ServicioFactory','ColaboradorFactory','CitaFactory')
        ...
        resolve: loadSequence('ngTable','UsuarioCtrl','UsuarioFactory','EmpresaFactory')
    }).state('app.adm', {
        url: '/adm',
        template: '<div ui-view class="fade-in-up"></div>',
        title: 'Adm',
        ...
        resolve: loadSequence('ngTable','UsuarioCtrl','UsuarioFactory')
        ...
        resolve: loadSequence('ngTable','SucursalCtrl','SucursalFactory')
