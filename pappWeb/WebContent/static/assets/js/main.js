...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: 'Sivtouch Smart Quote', // name of your project
        author: 'GlobalTech Smart Software', // author's name or company name
        description: 'Modulo de Citas  ', // brief description
        ...
        layout: {
            ...
            logo: 'assets/images/logosivtouch2.png', // relative path of the project logo
        }
    };
    $rootScope.user = {
        name: '',
