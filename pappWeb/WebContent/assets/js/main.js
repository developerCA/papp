...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        ...
        defaultLayout: {
            ...
            logo: 'assets/images/logoapp2.png', // relative path of the project logo
...
app.config(function ($breadcrumbProvider) {
    $breadcrumbProvider.setOptions({
        template: '<ul class="breadcrumb"><li><a ui-sref="app.dashboard"><i class="fa fa-home margin-right-5 text-large text-dark"></i>Inicio</a></li><li ng-repeat="step in steps">{{step.ncyBreadcrumbLabel}}</li></ul>'
    });
});
// ng-storage
