...
app.controller('ModalGradoController', [ "$scope","$uibModalInstance","SweetAlert","$filter", "ngTableParams","gradoFactory",  function($scope,$uibModalInstance,SweetAlert,$filter, ngTableParams,gradoFactory) {
