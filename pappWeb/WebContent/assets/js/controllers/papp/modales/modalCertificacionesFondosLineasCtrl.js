...
app.controller('ModalCertificacionesFondosLineasController', [ "$scope","$rootScope","ID","unidadID","editar","noeditar","$uibModalInstance","SweetAlert","$filter", "ngTableParams","certificacionesFondosFactory",
