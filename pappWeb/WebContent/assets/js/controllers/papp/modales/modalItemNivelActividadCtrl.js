...
app.controller('ModalItemNivelActividadController', ["$scope", "$rootScope", "$uibModalInstance","nivelactividadunidadid","$filter", "ngTableParams","ItemsFactory",
	function($scope, $rootScope, $uibModalInstance, nivelactividadunidadid, $filter, ngTableParams,itemsFactory) {
...
*/
    ...
    $scope.filtrar = function () {
        ...
        itemsFactory.traerItemsNivelActividadFiltroCustom(
        		$scope.pagina,
        		$rootScope.ejefiscal,
