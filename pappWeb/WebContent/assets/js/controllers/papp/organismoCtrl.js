...
app.controller('OrganismoController', [ "$scope","$rootScope","SweetAlert","$filter", "ngTableParams","organismoFactory",  function($scope,$rootScope,SweetAlert,$filter, ngTableParams,organismoFactory) {
