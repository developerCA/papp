...
app.controller('ReporteP04pacController', [ "$scope","$rootScope","$uibModal","SweetAlert","$filter", "ngTableParams","reporteP01Factory",
	...
	$scope.form = {
        submit: function (form) {
        	if (!$scope.objeto.institucionid) {
        		SweetAlert.swal("Reporte P04 PAC!", "Seleccione una Institucion", "error");
        		return;
        	}
        	var url = "/pappWeb/rest/reportes/consultar/p04pac/" +
