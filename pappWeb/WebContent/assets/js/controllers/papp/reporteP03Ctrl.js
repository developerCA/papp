...
app.controller('ReporteP03Controller', [ "$scope","$rootScope","$uibModal","SweetAlert","$filter", "ngTableParams","reporteP01Factory",
...
//        		return;
//        	}
        	var url = "/pappWeb/rest/reportes/consultar/p03/" +
