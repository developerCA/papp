...
app.controller('ReporteE06Controller', [ "$scope","$rootScope","$uibModal","SweetAlert","$filter", "ngTableParams","reporteP01Factory",
...
*/
        	var url = "/birt/frameset?__report=E06-RPAPP.rptdesign" +
